...
PARAMETER_VALUES_ERROR = (
    "The 'parameter_values' property must be an iterable of isatools.model.ParameterValue objects. {0} was supplied."
)
...
INVALID_MEASUREMENT_TYPE_ERROR = (
    "{0} is an invalid value for measurement_type. Please provide an OntologyAnnotation or string."
)
INVALID_TECHNOLOGY_TYPE_ERROR = (
    "{0} is an invalid value for technology_type. Please provide an OntologyAnnotation or string."
)
...
TREATMENT_MAP_ERROR = "treatment_map must be a list containing tuples with (Treatment, StudyAssayPlan) pairs."
GROUP_SIZES_ERROR = (
    "no group sizes have been provided. Group size(s) must be provided either as an integer or as"
