...
from isatools.create.constants import DATA_FILE, EXTRACT, LABELED_EXTRACT, ORGANISM_PART, SAMPLE
...
ms_assay_dict = OrderedDict(
    [
        ...
        ("raw spectral data file", [{"node_type": DATA_FILE, "size": 2, "is_input_to_next_protocols": False}]),
    ]
)
...
annotated_ms_assay_dict = OrderedDict(
    [
        (
            "measurement_type",
            OntologyAnnotation(
                term="metabolite profiling", term_accession="http://purl.obolibrary.org/obo/OBI_0000366"
            ),
        ),
        (
            "technology_type",
        ...
        (OntologyAnnotation(term="extraction", term_accession="http://purl.obolibrary.org/obo/OBI_0302884"), {}),
        (
            OntologyAnnotation(term="extract", term_accession="http://purl.obolibrary.org/obo/OBI_0000423"),
            [
                {
                    "node_type": EXTRACT,
                    "characteristics_category": OntologyAnnotation(
                        term="extract type", term_accession="http://purl.obolibrary.org/obo/NCIT_C82948"
                    ),
        ...
        (
            OntologyAnnotation(term="labelling", term_accession="http://purl.obolibrary.org/obo/CHMO_0001675"),
            {"#replicates": 2},
        ),
        (
            OntologyAnnotation(term="labelled extract", term_accession="http://purl.obolibrary.org/obo/OBI_0000924"),
            [
                {
                    "node_type": LABELED_EXTRACT,
                    "characteristics_category": OntologyAnnotation(
        ...
        (
            OntologyAnnotation(term="mass spectrometry", term_accession="http://purl.obolibrary.org/obo/OBI_0200085"),
            {
                "#replicates": 2,
                OntologyAnnotation(term="instrument"): [
                    OntologyAnnotation(
                        term="Agilent QTQF 6510", term_accession="http://purl.obolibrary.org/obo/MS_1000676"
                    )
                ],
                OntologyAnnotation(term="injection_mode"): [
                    OntologyAnnotation(term="FIA", term_accession="http://purl.obolibrary.org/obo/MS_1000058"),
                    OntologyAnnotation(term="LC", term_accession=""),
                ],
                OntologyAnnotation(term="acquisition_mode"): [
                    OntologyAnnotation(term="positive mode", term_accession="http://purl.obolibrary.org/obo/MS_1002807")
                ],
            },
        ),
        (
            OntologyAnnotation(
                term="raw spectral data file", term_accession="http://purl.obolibrary.org/obo/MS_1003083"
            ),
            [{"node_type": DATA_FILE, "size": 2, "is_input_to_next_protocols": False}],
        ),
    ]
)
...
phti_assay_dict = OrderedDict(
    [
        ...
        (
            ...
            [{"node_type": DATA_FILE, "size": 1, "technical_replicates": 2, "is_input_to_next_protocols": False}],
        ),
    ]
)
...
nmr_assay_dict = OrderedDict(
    [
        ...
        ("raw spectral data file", [{"node_type": DATA_FILE, "size": 1, "is_input_to_next_protocols": False}]),
    ]
)
