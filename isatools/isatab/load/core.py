...
from isatools.isatab.utils import IsaTabDataFrame, strip_comments
...
from .mapping import get_investigation_base_output, investigation_sections_mapping, study_sections_mapping
...
class ISATabLoaderStudyAssayMixin(metaclass=ABCMeta):
    ...
    @staticmethod
    def set_misc(
        target: Study | Assay, samples: dict, processes: dict, characteristic_categories: dict, unit_categories: dict
    ) -> Study | Assay:
