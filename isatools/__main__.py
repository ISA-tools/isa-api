...
def main(argv=None):
    ...
    p.add_argument(
        "-o",
        dest="out_path",
        help="out (file will be written out here or written to directory if ISA-Tab archive out)",
        required=True,
    )
    p.add_argument("--version", action="version", version="isatools {}".format("0.10"))
