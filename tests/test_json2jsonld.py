...
class TestJson2JsonLD(unittest.TestCase):
    ...
    def setUp(self):
        self.test_path = os.path.join(os.path.dirname(__file__), './data/json/BII-S-3/')
        output_path = os.path.join(self.test_path, "BII-S-3-ld-v0.json")
        ...
        self.serializer = ISALDSerializer(instance_url, "isaterms", False)
        # print(self.serializer.output)
    ...
    #         jsonld_path = os.path.join(self.test_path, "BII-S-3-ld-new-" + ontology + "-v1.json")
    #
    ...
    #         rdf_path = os.path.join(self.test_path, "BII-S-3-ld-new-" + ontology + "-v1.ttl")
