...
class TestIsaTabConfigurator(unittest.TestCase):
    ...
    def test_parse_configuration_genome_seq_xml(self):
        ...
        self.assertEqual(config_obj.isatab_configuration[0].measurement.term_label, "genome sequencing")
        self.assertEqual(config_obj.isatab_configuration[0].technology.term_label, "nucleotide sequencing")
        ...
        self.assertEqual(
            config_obj.isatab_configuration[0].field[0].generated_value_template,
