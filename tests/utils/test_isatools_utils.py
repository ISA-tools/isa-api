...
from isatools.model import Comment, OntologyAnnotation, OntologySource, Publication
...
class TestRecastColumns(unittest.TestCase):
    ...
    def test_mixed_columns(self):
        ...
        expected = ["Characteristics[Material Type]", "Other", "Parameter Value[Date]", "Parameter Value[Performer]"]
        self.assertEqual(utils.recast_columns(input_cols), expected)
