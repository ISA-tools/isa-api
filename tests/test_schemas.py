...
class ISASchemaTest(unittest.TestCase):
    ...
    def test_json_schemas(self):
        investigation_schema = json.load(open("schemas/investigation_schema.json"))
        Draft4Validator.check_schema(investigation_schema)

        common_definitions_schema = json.load(open("schemas/common_definitions_schema.json"))
        Draft4Validator.check_schema(common_definitions_schema)

        study_schema = json.load(open("schemas/study_schema.json"))
