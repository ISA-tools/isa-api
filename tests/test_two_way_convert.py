...
class TwoWayConvertTest(TestCase):
    ...
    def test_isa_sample_pool(self):
        ...
        self.assertTrue(isatab.assert_tab_equal(open(os.path.join(source_dir, 'i_investigation.txt')),
                                                open(os.path.join(self._tmp, 'i_investigation.txt'))))
        self.assertTrue(isatab.assert_tab_equal(open(os.path.join(source_dir, 's_TEST-Template3-Splitting.txt')),
                                                open(os.path.join(self._tmp, 's_TEST-Template3-Splitting.txt'))))
        self.assertTrue(isatab.assert_tab_equal(open(os.path.join(source_dir, 'a_test-template3-splitting_transcription_profiling_DNA_microarray.txt')),
    ...
    def test_isa_source_split(self):
        ...
        self.assertTrue(isatab.assert_tab_equal(open(os.path.join(source_dir, 'i_investigation.txt')),
                                                open(os.path.join(self._tmp, 'i_investigation.txt'))))
        self.assertTrue(isatab.assert_tab_equal(open(os.path.join(source_dir, 's_TEST-Template1-Splitting.txt')),
                                                open(os.path.join(self._tmp, 's_TEST-Template1-Splitting.txt'))))
        self.assertTrue(isatab.assert_tab_equal(open(os.path.join(source_dir, 'a_test-template1-splitting_transcription_profiling_DNA_microarray.txt')),
    ...
    #                             open(os.path.join(self._tmp, 'i_investigation.txt')))
    #     isatab.assert_tab_equal(open(os.path.join(source_dir, 's_TEST-Template5-repeatedmeasure.txt')),
    #                             open(os.path.join(self._tmp, 's_TEST-Template5-repeatedmeasure.txt')))
    #     isatab.assert_tab_equal(open(os.path.join(source_dir, 'a_test-template5-repeatedmeasure_transcription_profiling_DNA_microarray.txt')),
    ...
    #     isatab.assert_tab_equal(open(os.path.join(source_dir, 'i_investigation.txt')),
    #                             open(os.path.join(self._tmp, 'i_investigation.txt')))
    #     isatab.assert_tab_equal(open(os.path.join(source_dir, 's_TEST-Template1-Splitting.txt')),
    #                             open(os.path.join(self._tmp, 's_TEST-Template1-Splitting.txt')))
    #     isatab.assert_tab_equal(open(os.path.join(source_dir, 'a_test-template1-splitting_transcription_profiling_DNA_microarray.txt')),
    #                             open(os.path.join(self._tmp, 'a_test-template1-splitting_transcription_profiling_DNA_microarray.txt')))
    """
    ...
    """
    File "/Users/dj/PycharmProjects/isa-api/isatools/isajson.py", line 577, in load
