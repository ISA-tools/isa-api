...
class TestValidators(unittest.TestCase):
    ...
    def test_extend_rules(self):
        from isatools.isatab.validate.rules.defaults import DEFAULT_INVESTIGATION_RULES, INVESTIGATION_RULES_MAPPING
            ...
            "investigation": {
                "available_rules": [
                    *INVESTIGATION_RULES_MAPPING,
                    {"rule": is_investigation, "params": ["investigation_df_dict"], "identifier": "6000"},
                ],
