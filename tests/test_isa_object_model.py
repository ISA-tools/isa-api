...
class ISAModelTests(unittest.TestCase):
    ...
    def setUp(self):
        # define test fixture data using minimal information
        self._investigation_identifier = ""
        self._investigation_title = ""
        self._investigation_description = ""
        self._investigation_submissionDate = datetime.date
        self._investigation_publicReleaseDate = datetime.date

    def test_build_isa_objects(self):

        # INVESTIGATION
        i = Investigation(
            identifier=self._investigation_identifier,
            title=self._investigation_title,
            description=self._investigation_description,
            submissionDate=self._investigation_submissionDate,
            publicReleaseDate=self._investigation_publicReleaseDate
        )

        i_ontology_source = OntologySourceReference(
            name="OBI",
        ...
        i_publication = Publication(
            ...
            status=OntologyAnnotation(name="published")
        )
        ...
        s1_design_descriptor = OntologyAnnotation(
            name="intervention design",
            termSource="OBI",
            termAccession="http://purl.obolibrary.org/obo/OBI_0000115"
        )
        s1.designDescriptors.append(s1_design_descriptor)
        s1_publication = Publication(
            pubMedID="17439666",
            DOI="doi:10.1186/jbiol54",
            authorList="Castrillo JI, Zeef LA, Hoyle DC, Zhang N, Hayes A, Gardner DC, Cornell MJ, Petty J, Hakes L, Wardleworth L, Rash B, Brown M, Dunn WB, Broadhurst D, O'Donoghue K, Hester SS, Dunkley TP, Hart SR, Swainston N, Li P, Gaskell SJ, Paton NW, Lilley KS, Kell DB, Oliver SG.",
            title="Growth control of the eukaryote cell: a systems biology study in yeast.",
        ...
        s1_factor1 = StudyFactor(
            name="limiting nutrient",
            type=OntologyAnnotation(name="chemical compound")
        )
        s1_factor2 = StudyFactor(
            name="rate",
        ...
        s1.factors.append(s1_factor1)
        s1.factors.append(s1_factor2)
        ...
        s1_protocol1 = StudyProtocol(
            name="growth protocol",
            protocolType=OntologyAnnotation(name="growth"),
        ...
        s1_protocol2 = StudyProtocol(
            name="mRNA extraction",
            protocolType=OntologyAnnotation(name="mRNA extraction"),
        ...
        s1_protocol3 = StudyProtocol(
            name="protein extraction",
            protocolType=OntologyAnnotation(name="protein extraction")
        )
        s1_protocol4 = StudyProtocol(
            name="biotin labeling",
            protocolType=OntologyAnnotation(name="labeling"),
        ...
        s1_protocol5 = StudyProtocol(
            name="ITRAQ labeling",
            protocolType=OntologyAnnotation(name="labeling")
        )
        s1_protocol6 = StudyProtocol(
            name="EukGE-WS4",
            protocolType=OntologyAnnotation(name="hybridization"),
        ...
        s1_protocol7.parameters.append(OntologyAnnotation(name="sample value"))
        s1_protocol7.parameters.append(OntologyAnnotation(name="standard volume"))
        ...
        s1_contact1.roles.append(OntologyAnnotation(name="corresponding author"))
        ...
        s1_contact2.roles.append(OntologyAnnotation(name="author"))
        ...
        s1_contact3.roles.append(OntologyAnnotation(name="author"))
