...
class JsonToTabTest(TestCase):
    ...
    def test_source_split_assay_table(self):
        json2isatab.convert(open(os.path.join(self._dir, 'TEST-ISA-source-split.json')), self._tmp)
        self.assertTrue(assert_tab_content_equal(open(os.path.join(self._tmp, 'a_test-template1-splitting_transcription_profiling_DNA_microarray.txt')),
    ...
    def test_sample_pool_assay_table(self):
        json2isatab.convert(open(os.path.join(self._dir, 'TEST-ISA-sample-pool.json')), self._tmp)
        self.assertTrue(assert_tab_content_equal(open(os.path.join(self._tmp, 'a_test-template3-splitting_transcription_profiling_DNA_microarray.txt')),
    ...
    def test_bii_s_3_investigation(self):
        ...
        self.assertTrue(assert_tab_content_equal(open(os.path.join(self._tmp, 'i_investigation.txt')),
                                         open(os.path.join(self._dir, 'data/BII-S-3/i_gilbert.txt'))))
