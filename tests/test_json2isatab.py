...
class TestJson2IsaTab(unittest.TestCase):
    ...
    def test_json2isatab_convert_source_split_study_table(self):
        ...
        self.assertTrue(assert_tab_content_equal(open(os.path.join(self._tmp, 's_TEST-Template1-Splitting.txt')),
                                                 open(os.path.join(self._data_dir, 'TEST-ISA-source-split',
    ...
    def test_json2isatab_convert_sample_pool_study_table(self):
        ...
        self.assertTrue(assert_tab_content_equal(open(os.path.join(self._tmp, 's_TEST-Template3-Splitting.txt')),
                                                 open(os.path.join(self._data_dir, 'TEST-ISA-sample-pool',
    ...
    def test_json2isatab_convert_bii_s_3_investigation(self):
        json2isatab.convert(open(os.path.join(self._data_dir, 'BII-S-3', 'BII-S-3.json')), self._tmp)
        self.assertTrue(assert_tab_content_equal(open(os.path.join(self._tmp, 'i_investigation.txt')),
                                         open(os.path.join(self._data_dir, 'BII-S-3', 'i_gilbert.txt'))))
    ...
    def test_json2isatab_convert_bii_s_3_study_table(self):
        ...
        self.assertTrue(assert_tab_content_equal(open(os.path.join(self._tmp, 's_BII-S-3.txt')),
                                                 open(os.path.join(self._data_dir, 'BII-S-3', 's_BII-S-3.txt'))))

    def test_json2isatab_convert_bii_s_3_assay_table_Tx(self):
        json2isatab.convert(open(os.path.join(self._dir, 'data/BII-S-3/BII-S-3.json')), self._tmp)
        self.assertTrue(assert_tab_content_equal(open(os.path.join(self._tmp, 'a_gilbert-assay-Tx.txt')),
                                                 open(os.path.join(self._data_dir, 'BII-S-3',
                                                                   'a_gilbert-assay-Tx.txt'))))

    def test_json2isatab_convert_bii_s_3_assay_table_Gx(self):
        json2isatab.convert(open(os.path.join(self._dir, 'data/BII-S-3/BII-S-3.json')), self._tmp)
        self.assertTrue(assert_tab_content_equal(open(os.path.join(self._tmp, 'a_gilbert-assay-Gx.txt')),
                                                 open(os.path.join(self._data_dir, 'BII-S-3',
