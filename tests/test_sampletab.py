...
class UnitSampleTabDump(unittest.TestCase):
    ...
    def test_sampletab_dump_test1(self):
        ...
        ISA.ontology_source_references = [
            OntologySource(
                name="NCBI Taxonomy", description="NCBI Taxonomy", file="http://www.ncbi.nlm.nih.gov/taxonomy/"
            ),
        ...
        study.characteristic_categories = [sample_accession_charac, sample_description_charac, derived_from_charac]
        study.sources = [
            Source(
                name="sample1",
                characteristics=[
