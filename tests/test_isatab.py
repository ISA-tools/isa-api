...
class TestIsaTabLoad(unittest.TestCase):
    ...
    def test_isatab_load_issue200(self):
        with open(os.path.join(self._tab_data_dir, 'issue200', 'i_Investigation.txt')) as fp:
            ...
            self.assertEqual(len(ISA.studies[0].assays[0].data_files), 2)  # FIXME: Missing Derived Data File
    ...
    # def test_isatab_load__flower(self):  # don't commit this as it takes 3 minutes to run on local machine
