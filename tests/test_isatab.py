...
class TestIsaTabDump(unittest.TestCase):
    ...
    def test_isatab_dump_investigation_multiple_comments(self):
        ...
        # data_collection_protocol.comments.append(Comment(name="Protocol Start Date", value=""))
        ...
        # study.protocols[1].comments.append()
        # study.protocols[0].comments.append(Comment(name="Protocol End Date", value=""))
        # study.protocols[1].comments.append(Comment(name="Protocol End Date", value="2017-08-11"))
        ...
        f1.comments.append(Comment(name="Factor1 comment1", value="Saturn"))
        f2.comments.append(Comment(name="Factor1 comment2", value="2039-12-12"))
        ...
        assay.comments.append(Comment(name="Assay Descriptor", value="Intelligent Assay Design"))
        ...
        print("creating in test_isatab: ", investigation)
