...
class JsonToSraTest(TestCase):
    ...
    #         expected_submission_file = open(os.path.join(work_dir, 'sra', 'submission.xml'), 'rb')
    ...
    #         logger.info("Comparing length of output of SRA conversion to expected test data...")
    #         logger.info("Test={}, expected={}".format(len(etree.tostring(test_submission_xml_obj)), len(etree.tostring(expected_submission_xml_obj))))
    #         self.assertEqual(len(etree.tostring(test_submission_xml_obj)), len(etree.tostring(expected_submission_xml_obj)))
    #
    #         # compare study.xml
    ...
    #         expected_study_file = open(os.path.join(work_dir, 'sra', 'study.xml'), 'rb')
    #         logger.info("Opening: " + expected_study_file.name)
    #         expected_study_xml_obj = objectify.fromstring(expected_study_file.read())
    #         logger.info("Comparing length of output of SRA conversion to expected test data...")
    #         logger.info("Test={}, expected={}".format(len(etree.tostring(test_study_xml_obj)),
    #                                                   len(etree.tostring(expected_study_xml_obj))))
    #         self.assertEqual(len(etree.tostring(test_study_xml_obj)), len(etree.tostring(expected_study_xml_obj)))
    #
    ...
    #         expected_experiment_set_file = open(os.path.join(work_dir, 'sra', 'experiment_set.xml'), 'rb')
    ...
    #         logger.info("Comparing length of output of SRA conversion to expected test data...")
    #         logger.info("Test={}, expected={}".format(len(etree.tostring(test_experiment_set_xml_obj)),
    #                                                   len(etree.tostring(expected_experiment_set_xml_obj))))
    #         self.assertEqual(len(etree.tostring(test_experiment_set_xml_obj)), len(etree.tostring(expected_experiment_set_xml_obj)))
    #
    #         # compare run_set.xml
    ...
    #         expected_run_set_file = open(os.path.join(work_dir, 'sra', 'run_set.xml'), 'rb')
    #         logger.info("Opening: " + expected_run_set_file.name)
    #         expected_run_set_xml_obj = objectify.fromstring(expected_run_set_file.read())
    #         logger.info("Comparing length of output of SRA conversion to expected test data...")
    #         logger.info("Test={}, expected={}".format(len(etree.tostring(test_run_set_xml_obj)),
    #                                                   len(etree.tostring(expected_run_set_xml_obj))))
    #         self.assertEqual(len(etree.tostring(test_run_set_xml_obj)),
    #                          len(etree.tostring(expected_run_set_xml_obj)))
    #
    ...
    #         expected_sample_set_file = open(os.path.join(work_dir, 'sra', 'sample_set.xml'), 'rb')
    ...
    #         logger.info("Comparing length of output of SRA conversion to expected test data...")
    #         logger.info("Test={}, expected={}".format(len(etree.tostring(test_sample_set_xml_obj)),
    #                                                   len(etree.tostring(expected_sample_set_xml_obj))))
    #         self.assertEqual(len(etree.tostring(test_sample_set_xml_obj)),
    #                          len(etree.tostring(expected_sample_set_xml_obj)))
    #
    ...
    #         expected_submission_xml_obj = objectify.fromstring(expected_submission_file.read())
    #         logger.info("Comparing length of output of SRA conversion to expected test data...")
    #         logger.info("Test={}, expected={}".format(len(etree.tostring(test_submission_xml_obj)),
    #                                                   len(etree.tostring(expected_submission_xml_obj))))
    #         self.assertEqual(len(etree.tostring(test_submission_xml_obj)),
    #                          len(etree.tostring(expected_submission_xml_obj)))
    #
    #         # compare study.xml
    #         test_study_file = open(os.path.join(expected_sra_path, 'study.xml'), 'rb')
