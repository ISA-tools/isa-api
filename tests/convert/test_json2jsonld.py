...
class TestISALDSerializer(unittest.TestCase):
    ...
    class TestInjectLDSplit(unittest.TestCase):
        @patch(
            "isatools.convert.json2jsonld.open",
        ...
        def test_inject_ld_split_with_array(self):
            serializer = ISALDSerializer(json_instance={})
            serializer.schemas = {
                "test_schema.json": {"properties": {"array_field": {"type": "array", "items": {"type": "string"}}}}
            }
        ...
        def test_inject_ld_split_with_object(self):
            ...
            serializer.schemas = {
                "test_schema.json": {
                    "properties": {"object_field": {"type": "object", "properties": {"subfield": {"type": "string"}}}}
                }
            }
        ...
        def test_inject_ld_split_with_ref(self):
            serializer = ISALDSerializer(json_instance={})
            serializer.schemas = {
                "test_schema.json": {"properties": {"ref_field": {"$ref": "ref_schema.json"}}},
                "ref_schema.json": {"properties": {"nested_field": {"type": "string"}}},
            }
        ...
        def test_inject_ld_split_with_anyOf(self):
            serializer = ISALDSerializer(json_instance={})
            serializer.schemas = {
                "test_schema.json": {"properties": {"value": {"anyOf": [{"$ref": "ref_schema.json"}]}}},
                "ref_schema.json": {"properties": {"nested_field": {"type": "string"}}},
            }
        ...
        def test_inject_ld_split_with_nested_array_of_objects(self):
            ...
            serializer.schemas = {
                "test_schema.json": {
                    "properties": {"array_field": {"type": "array", "items": {"$ref": "nested_schema.json"}}}
                },
                "nested_schema.json": {"properties": {"subfield": {"type": "string"}}},
            }
...
class TestISALDSerializerAdditional(unittest.TestCase):
    ...
    def test_get_context_url_with_edge_case(self):
        serializer = ISALDSerializer(json_instance={})
        url = serializer._get_context_url(
            "https://raw.githubusercontent.com/ISA-tools/isa-api/develop/isatools/resources/json-context/obo/isa_isa_test_obo_context.jsonld"
        )
        self.assertIn(
            "https://raw.githubusercontent.com/ISA-tools/isa-api/develop/isatools/resources/json-context/obo/isa_isa_test_obo_context.jsonld",
            url,
