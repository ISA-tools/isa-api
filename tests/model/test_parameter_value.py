...
class TestParameterValue(TestCase):
    ...
    def test_value(self):
        ...
        expected_error = (
            "ParameterValue.value must be a string, numeric, an OntologyAnnotation, or None; "
    ...
    def test_unit(self):
        ...
        self.assertEqual(
            str(context.exception), "ParameterValue.unit must be a OntologyAnnotation, or None; got test:<class 'str'>"
        )
    ...
    def test_from_dict(self):
        ...
        indexes.add_parameter(ProtocolParameter(id_="mycat", parameter_name=OntologyAnnotation(id_="valueID")))
