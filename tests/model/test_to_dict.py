...
class LDTest(TestCase):
    ...
    def test_to_ld(self):
        ...
        characteristic = Characteristic(
            category=category, value=OntologyAnnotation(term="my characteristic value", id_="char_val_id")
        )
        ...
        factor_value = FactorValue(factor_name=study_factor, value=OntologyAnnotation(term="value"))
        sample = Sample(
            name="sample1",
            id_="sample_id",
            comments=[comment_1],
        ...
        process = Process(name="p1", id_="process_id_1", executes_protocol=protocol, inputs=[source], outputs=[sample])
