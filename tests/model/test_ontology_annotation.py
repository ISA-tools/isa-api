...
from isatools.model import Commentable, OntologyAnnotation, OntologySource
...
class TestOntologyAnnotation(TestCase):
    ...
    def test_setters(self):
        ...
        self.assertTrue(
            "OntologyAnnotation.term_source must be a OntologySource or None; got term-source:<class 'str'>"
    ...
    def test_builtins(self):
        expected_str = (
            "isatools.model.OntologyAnnotation(term='test_term', "
