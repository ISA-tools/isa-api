...
expected_repr = "isatools.model.Publication(pubmed_id='', doi='', author_list='', title='', status=None, comments=[])"
...
class TestPublication(TestCase):
    ...
    def test_status(self):
        ...
        self.assertTrue(
            "Publication.status must be a OntologyAnnotation or None; got 1:<class 'int'>" in str(context.exception)
        )
    ...
    def test_dict(self):
        ...
        expected_dict = {
            ...
            "doi": "doi",
            "pubMedID": "pubmed_id",
            "status": {"@id": "123", "annotationValue": "OA", "termSource": "", "termAccession": "", "comments": []},
            "title": "",
            "comments": [],
        }
