...
class StudyTest(TestCase):
    ...
    def test_design_descriptors(self):
        ...
        with self.assertRaises(AttributeError) as context:
            self.study.design_descriptors = 456
        self.assertEqual(
            "Study.design_descriptors must be iterable containing OntologyAnnotations", str(context.exception)
        )
    ...
    def test_dict(self):
        ...
        expected_dict = {
            ...
            "materials": {
                "sources": [{"@id": "source_id", "name": "source name", "comments": [], "characteristics": []}],
                "samples": [
                    {
                        "@id": "my_sample",
                        "name": "source name",
