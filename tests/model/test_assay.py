...
class TestAssay(TestCase):
    ...
    def test_init(self):
        assay = Assay(
            measurement_type=OntologyAnnotation(term="MT"),
    ...
    def test_measurement_type(self):
        ...
        self.assertTrue(
            "Assay.measurement_type must be a OntologyAnnotation or None; got 1:<class 'int'>" in str(context.exception)
        )
    ...
    def test_technology_type(self):
        ...
        self.assertTrue(
            "Assay.technology_type must be a OntologyAnnotation or None; got 1:<class 'int'>" in str(context.exception)
        )
    ...
    def test_technology_platform(self):
        ...
        self.assertTrue(
            "Assay.technology_platform must be a str or None; got 1:<class 'int'>" in str(context.exception)
        )
    ...
    def test_data_files(self):
        ...
        self.assertTrue("Assay.data_files must be iterable containing DataFiles" in str(context.exception))

    def test_repr(self):
        expected_str = (
            "isatools.model.Assay(measurement_type="
    ...
    def test_to_dict(self, mock_uuid4):
        ...
        protocol = Protocol(id_="my_protocol_id2", protocol_type=OntologyAnnotation(term="data collection"))
        indexes.add_protocol(protocol)
        ...
        expected_dict["processSequence"][0]["parameterValues"] = [
            {"category": {"@id": "#parameter/Array_Design_REF"}, "value": "a value"}
        ]
        assay = Assay()
        assay.from_dict(expected_dict, study)
    ...
    def test_io_errors_in_load(self):
        ...
        expected_dict = {
            ...
            "materials": {"samples": [], "otherMaterials": []},
            "dataFiles": [],
            "processSequence": [{"executesProtocol": {"@id": "123"}, "inputs": [{"@id": "error_id"}]}],
        }
