...
class TestOntologySource(TestCase):
    def setUp(self):
        self.ontology_source = OntologySource(
            name="test_name", file="test_file", version="test_version", description="test_description"
        )
    ...
    def test_builtins(self):
        expected_str_template = (
            "isatools.model.OntologySource(name='test_name', "
            "file='test_file', "
