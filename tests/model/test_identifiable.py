...
class TestIdentifiable(TestCase):
    ...
    def setUp(self):
        self.identifiable = Identifiable(id_='test_id')
    ...
    def test_id(self, mock_uuid4):
        ...
        self.assertTrue(self.identifiable.id == '#identifiable/test_id_2')
        self.identifiable.id = None
        self.assertTrue(self.identifiable.id == '#identifiable/' + mock_uuid4.return_value)
