...
expected_repr_string = (
    "isatools.model.Protocol(name='', protocol_type=isatools.model.OntologyAnnotation("
...
class TestProtocol(TestCase):
    ...
    def test_init(self):
        ...
        protocol = Protocol(
            ...
            components=[ontology_annotation],
        )
    ...
    def test_protocol_type(self):
        ...
        self.assertTrue(
            "Protocol.protocol_type must be a OntologyAnnotation, a string or None; "
    ...
    def test_parameters(self):
        ...
        self.assertTrue(
            "Protocol.parameters must be an iterable containing ProtocolParameters" in str(context.exception)
        )
    ...
    def test_components(self):
        ...
        self.assertTrue("Protocol.components must be iterable containing OntologyAnnotations" in str(context.exception))
    ...
    def test_dict(self):
            ...
            "parameters": [
                {
                    "parameterName": {
                        "@id": "protocol_name_id",
                        "annotationValue": "test_parameter",
                        "termSource": "",
                        "termAccession": "",
                        "comments": [],
                    },
        ...
        component_type = OntologyAnnotation(
            id_="component_type_id", term="component_type_value", term_accession="1111", term_source=""
        )
        protocol_component = ProtocolComponent(name="component name", component_type=component_type)
        protocol = Protocol(
            name="test_name", id_="test_id", parameters=[protocol_parameter], protocol_type=protocol_type
        )
