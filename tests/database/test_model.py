...
try:
    ...
    class TestAssertions(TestCase):
        ...
        def test_assay_base_assertions(self):
            ...
            for assay_1 in assays_from_db:
                ...
                self.assertEqual(
                    sorted(assay_1.units, key=lambda d: d.term), sorted(assay_2.units, key=lambda d: d.term)
                )
                self.assertEqual(
    ...
    warnings.warn("database packages are not installed. Skipping database test...")
