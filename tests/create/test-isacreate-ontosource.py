...
from isatools.model import Comment, Investigation, OntologyAnnotation, OntologySource, Person
...
class MyTestCase(unittest.TestCase):
    def setUp(self):
        ...
        ontologies = {
            "chebi": OntologySource(name="CHEBI", description="Chemical Entities of Biological Interest"),
            "chmo": OntologySource(name="CHMO", description="Chemical Methods Ontology"),
            "msio": OntologySource(name="MSIO", description="Metabolite Standards Initiative Ontology"),
            "ncbitaxon": OntologySource(name="NCBITAXON", description="NCBI organismal classification"),
            "ncit": OntologySource(name="NCIT", description="NCI Thesaurus OBO Edition"),
            "obi": OntologySource(name="OBI", description="Ontology for Biomedical Investigations"),
            "ms": OntologySource(name="MS", description="MS - the Mass Spectrometry Ontology"),
            "uo": OntologySource(name="UO", description="UO - the Unit Ontology"),
            "pato": OntologySource(name="PATO", description="PATO - the Phenotype And Trait Ontology"),
        ...
        set_default_species(
            term=PTox_NAM, term_accession=base_url + onto_mapping[PTox_NAM], term_source=ontology_source
        )

        charact_cat = OntologyAnnotation(term="organism part")
        charact_value = OntologyAnnotation(
            term="whole organism", term_accession="https://purl.obolibrary.org/obo/OBI_0100026", term_source="OBI"
        )
            ...
            [
                    ...
                    [
                        {
                            ...
                            "characteristics_value": OntologyAnnotation(
                                term="polar fraction", term_source="", term_accession=""
                            ),
                            "size": 1,
                            "is_input_to_next_protocols": True,
                        },
                ...
                (
                    "derivatization",
                    {
                        ...
                        OntologyAnnotation(
                            term="derivatization agent",
                            term_source="MSIO",
                            term_accession="http://purl.obolibrary.org/obo/MSIO_0000029",
                        ): [
                            OntologyAnnotation(
                                term="N-(tert-butyldimethylsilyl)-N-methyltrifluoroacetamide",
                                term_source="CHEBI",
                    ...
                    [
                        {
                            ...
                            "characteristics_category": OntologyAnnotation(
                                term="labeled extract type", term_source="", term_accession=""
                            ),
                            "characteristics_value": OntologyAnnotation(term="", term_source="", term_accession=""),
                            "size": 1,
                            "is_input_to_next_protocols": True,
                        }
                    ],
                ...
                (
                    "mass spectrometry",
                    {
                        ...
                        OntologyAnnotation(
                            ...
                            OntologyAnnotation(
                                term="7000A Triple Quadrupole GC/MS",
                                term_source="MS",
                                term_accession="http://purl.obolibrary.org/obo/MS_1002802",
                            )
                        ],
                        OntologyAnnotation(term="injection_mode", term_source="", term_accession=""): [
                            OntologyAnnotation(
                                term="GC", term_source="MS", term_accession="http://purl.obolibrary.org/obo/MS_1002272"
                            )
                        ],
                        OntologyAnnotation(
                ...
                (
                    ...
                    [{"node_type": DATA_FILE, "size": 1, "extension": "mzml.gz", "is_input_to_next_protocols": False}],
                ),
            ]
        )
        ...
        rna_seq_assay_dict = OrderedDict(
            [
                ...
                (
                    "library_preparation",
                    {
                        OntologyAnnotation(term="library strategy", term_source="", term_accession=""): [
                            OntologyAnnotation(
                                term="RNA-SEQ",
                                term_source="OBI",
                        ...
                        OntologyAnnotation(term="library layout", term_source="", term_accession=""): [
                            OntologyAnnotation(term="PAIRED")
                        ],
        ...
        FACTORS_0_VALUE_1 = (
            OntologyAnnotation(
                term="ethoprophos", term_accession="https://purl.obolibrary.org/obo/CHEBI_38665", term_source="CHEBI"
            ),
            None,
        )
        FACTORS_0_VALUE_2 = (
            OntologyAnnotation(
                term="pirinixic acid", term_accession="https://purl.obolibrary.org/obo/CHEBI_32509", term_source="CHEBI"
            ),
            None,
        )

        # factor values for the second factor (intensity)
        FACTORS_1_UNIT = OntologyAnnotation(
            term="kg/m^3", term_accession="https://purl.obolibrary.org/obo/UO_0000083", term_source="UO"
        )
        ...
        FACTORS_2_UNIT = OntologyAnnotation(
            term="hr", term_accession="https://purl.obolibrary.org/obo/UO_0000032", term_source="UO"
        )
        ...
        sample_assay_plan = SampleAndAssayPlan.from_sample_and_assay_plan_dict(
            "test", sample_list, ms_assay_dict, rna_seq_assay_dict
        )
        ...
        [
            (process.name, getattr(process.prev_process, "name", None), getattr(process.next_process, "name", None))
            for process in treatment_assay.process_sequence
        ]

        isa_investigation.studies = [study]

        sra_broker_associated_cmts = [
            Comment(name="SRA Broker Name", value="OXFORD"),
        ...
        default_contact = Person(
            ...
            comments=[Comment(name="Study Person REF", value="https://orcid.org/0000-0002-6966-2972")],
        )
